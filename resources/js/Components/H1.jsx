        ...
        <div className="header mx-auto h-[70vh] flex flex-col lg:flex-row items-center justify-between relative">
            <div className="bg-white z-10 lg:w-1/2 max-w-lg lg:pr-8 p-4">
                ...
                <a href="#" className="bluebutton hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    Crie sua conta
                    <svg className="hover rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                    </svg>
                </a>
            </div>
            <div className="bg-image-container lg:w-1/2 h-full bg-cover bg-right relative">
                <div className="absolute inset-0 bg-gradient-to-l from-white to-transparent opacity-50"></div>
            </div>
        </div>
    );
};
